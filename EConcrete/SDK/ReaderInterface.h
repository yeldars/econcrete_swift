...
/**
*1.readerInterfaceDidChange using to monitor reader status - 
	YES means reader inserted
	NO means reader has being plug-out
*2. 2.cardInterfaceDidDetach using to monitor card status - 
	YES means the card inserted
	NO means card has being plug-out
	(Notice: This API doesn't tell customer the power status of card. To know the power status, please call SCardStatus API)
*/
