...
#ifdef HSM_GAMMA_X64
typedef unsigned int ck_object_handle_t;
typedef unsigned int ck_object_class_t;
#else
...
#ifdef HSM_GAMMA_X64
typedef unsigned int ck_key_type_t;
#else
...
#define CKM_KNCA_DEFINED			   		(CKM_VENDOR_DEFINED + 0x04B5A000)

#define CKM_GOST34310_2004_KEY_PAIR_GEN		(CKM_KNCA_DEFINED + 0x00000001)
#define CKM_GOST34310_2004					(CKM_KNCA_DEFINED + 0x00000002)

#define CKM_GOST34311						(CKM_KNCA_DEFINED + 0x00000021)

// Gamma tech GOST mechanism
#define CKM_CERTEX_GOSTR3410_2001            0x8E00000C
...
_CK_DECLARE_FUNCTION (C_SetSCContext,
		      (unsigned long hSContext));
...
struct ck_function_list
{
  ...
  CK_C_SetSCContext C_SetSCContext;
};
