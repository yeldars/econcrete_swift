...
/**
 * Set scardcontext if exists
 *
 * @param ctx context allocated by PKCS11_CTX_new()
 * @param scardcontext that will be set to global
 * @retval soon will write...
 */
extern int PKCS11_set_scardcontext(PKCS11_CTX *ctx, unsigned long hSContext);
...
#define PKCS11_F_PKCS11_GOST_SIGN 		50
#define PKCS11_F_PKCS11_GOST_KEY_SIGN 		51
